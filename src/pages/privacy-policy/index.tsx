                ...
                <div className={styles.container}>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            Мы, компания <strong>Bayar</strong>, уважаем вашу конфиденциальность и
                            обязуемся защищать ваши персональные данные. Эта Политика
                            конфиденциальности объясняет, как мы собираем, используем и защищаем
                            информацию, которую вы предоставляете при использовании нашего сайта{' '}
                            <a
                                className={styles.link}
                                href="https://tatbayar.ru"
                                target="_blank"
                    ...
                    <section className={styles.section}>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li>
                                Файлы cookie и данные об активности на сайте (например, IP-адрес).
                            </li>
                        </ul>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            вами (например, передача данных курьерским службам или платежным
                            системам).
                        </p>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            использование SSL-шифрования, двухфакторной аутентификации и других
                            средств безопасности для защиты от несанкционированного доступа и
                            утечек.
                        </p>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            Ваши данные будут храниться до тех пор, пока у вас есть активная учетная
                            запись или в течение срока, необходимого для выполнения юридических
                            обязательств, в зависимости от типа данных.
                        </p>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            Вы имеете следующие права относительно своих персональных данных:
                        </p>
                        <ul className={styles.list}>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            Наш сайт использует cookies для улучшения пользовательского опыта. Вы
                            можете отключить cookies в настройках вашего браузера, но это может
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            ...
                            конфиденциальности. Все изменения будут публиковаться на этой странице,
                            а дата последнего обновления будет указана в нижней части страницы.
                        </p>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p className={styles.text}>
                            Если у вас есть вопросы или запросы относительно этой Политики
                            конфиденциальности, вы можете связаться с нами по адресу:
                        </p>
                        <p className={styles.text}>
                            Email:{' '}
                            <a className={styles.link} href="mailto:support@bayar.com">
                                info@bayar.com
                            </a>
                        </p>
                    </section>
